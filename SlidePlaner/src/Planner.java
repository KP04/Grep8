   ...
   while(cPoint < operators.size()){
    ...
    if(tmpPoint != -1){
     ...
     if(str.equals("move 1")){
    	 ...
    	 //現在のオペレータの状態の表示    	 
      	 for (int i = 0; i < operators.size(); i++)
     		 System.out.println(((Operator)operators.elementAt(i)).name + "a");
    	...
    	//現在のオペレータの状態の表示    	 
      	 for (int i = 0; i < operators.size(); i++)
    	 	 System.out.println(((Operator)operators.elementAt(i)).name + "b");
    	...
    	//現在のオペレータの状態の表示    	 
    	 for (int i = 0; i < operators.size(); i++)
      		 System.out.println(((Operator)operators.elementAt(i)).name + "c");
    	...
    	//現在のオペレータの状態の表示    	 
    	 for (int i = 0; i < operators.size(); i++)
      		 System.out.println(((Operator)operators.elementAt(i)).name + "d");
     }
  ...
  */
  ...
  for(int i = cPoint ; i < operators.size() ; i++){
   ...
   for(int j = 0; j < operators.size(); j++){
	   Operator ope = (Operator)operators.elementAt(j);
